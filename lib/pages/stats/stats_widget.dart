...
/// Can you create page UI (that connects to the firebase backend) that will
/// display user metrics and stats such as money saved, recipes saved, etc.?
