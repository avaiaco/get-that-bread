                      ...
                      children: [
                        Align(
                          ...
                          child: FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'UPDATE_PASSWORD_COMP_close_ICN_ON_TAP');
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'UPDATE_PASSWORD_SubmitNewPass_ON_TAP');
                            logFirebaseEvent('SubmitNewPass_auth');
                            ...
                            logFirebaseEvent('SubmitNewPass_navigate_back');
                            context.safePop();
                          },
